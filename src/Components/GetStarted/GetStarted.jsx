...
const GetStarted = () => {
    return (
        <div className='bg-base-300 mt-15'>
            ...
            <div>
                <p className='text-[38px] font-bold text-[#101727] text-center'>
            ...
            <div className='grid grid-cols-3 gap-10 mt-5 mb-5'>
                <div className='bg-base-100 p-7 border border-base-300 rounded-lg shadow-sm h-75 space-y-3'>
                ...
                <div className='bg-base-100 h-75 space-y-3 p-7 border border-base-300 rounded-lg shadow-sm'>
                    <div className='flex justify-end items-center '>
