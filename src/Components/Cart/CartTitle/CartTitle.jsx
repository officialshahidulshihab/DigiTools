...
const CartTitle = ({select, setSelected}) => {
    ...
    return (
        <div className='w-11/12 mx-auto mt-20 mb-5 space-y-2'>
            ...
            <div className='flex justify-center'>
                ...
                <button onClick={()=>setSelected(false)} className={`btn ${select===false? 'bg-linear-to-r from-[#4f39f6] to-[#9514fa] text-white' : ''} rounded-r-2xl`}>Cart()</button>
            </div>
        </div>
    );
};
